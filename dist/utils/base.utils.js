...
function parseListField(list, parseFields) {
    return list.map(item => {
        const newItem = { ...item }; // eslint-disable-line @typescript-eslint/no-explicit-any
